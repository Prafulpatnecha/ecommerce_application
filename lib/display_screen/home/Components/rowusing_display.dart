...
Widget bottomNavigationcart()
{
  return Container(
    ...
    child: Row(
      ...
      children: [
        const Icon(Icons.shopping_bag_outlined,size: 30,color: Colors.black,),
        const SizedBox(width: 10,),
        Text('ADD TO CART',style: GoogleFonts.bungee(textStyle: const TextStyle(fontSize: 20,height: 1.7,color: Colors.black),),),
      ],
    ),
  );
}
